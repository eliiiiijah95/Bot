...
from cleanbot.db.queries import (
    ...
    get_type_access,
    orm_add_customer,
    orm_add_profession_and_category,
    orm_add_user_id_access,
    orm_check_trial,
    orm_get_category,
    orm_get_information,
    orm_get_information_for_exel,
    orm_get_profession,
    orm_get_time_sub,
    orm_save_user_consent,
    orm_unsubscribe_access,
    orm_unsubscribe_customer,
    orm_update_customer_field,
    save_business_access,
)
from cleanbot.integrations.yookassa import create_initial_payment
from cleanbot.payments.utils import humanize_subscription_time
from cleanbot.ui.keyboards import (
    action_selection_keyboard,
    company_check_keyboard,
    confirm_conditions,
    confirm_subscription_keyboard,
    existing_user_menu_keyboard,
    first_time_menu_keyboard,
    help_keyboard,
    main_menu_keyboard,
    profession_selection_keyboard,
    skip,
    social_media_keyboard,
    subscription_options_keyboard,
    unsubscribe_keyboard_access,
    unsubscribe_keyboard_customer,
    to_change_contacts,
    to_change_information,
)
...
async def save_and_finish(message: Message, state: FSMContext, session: AsyncSession):
    ...
    try:
        ...
        user_sub = humanize_subscription_time(get_time)
