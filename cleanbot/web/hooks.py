"""FastAPI router that handles YooKassa webhooks."""
...
from cleanbot.db.queries import (
    orm_save_payment_method_id,
    orm_save_payment_method_id_for_table,
    orm_update_access_type_for_table,
    orm_update_subscription_time,
    orm_update_subscription_time_for_table,
    orm_update_trial_time,
)
from cleanbot.db.session import get_async_session_dependency
from cleanbot.ui.keyboards import get_table_to_view, keyboard_start_questionnaire
...
async def yookassa_webhook(
    ...
    logging.info("Webhook от Юкассы: %s", data)
